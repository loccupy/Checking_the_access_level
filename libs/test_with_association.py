...
def get_the_counter_characteristics():
    ...
    try:
        ...
        return device_type, serial_number, proshivka
    except Exception as e:
        settings.media.close()
        print('Ошибка при получении характеристик счетчика!!!')
        raise e


def debug(device_type, serial_number, proshivka):

    try:
        reader, settings = connect_with_access_reader()
        print('\n_____________________________________________________________________________')
        print(f'Проверяется счетчик типа {device_type} №{serial_number} на прошивке [{proshivka}] (НЕ СПОДЕС)...')
        settings.media.open()
        reader.initializeConnection()
        ...
        print(f'\nПРОВЕРКА счетчика №{serial_number} (НЕ СПОДЕС) ЗАКОНЧЕНА')
        print('_____________________________________________________________________________')
    except Exception as e:

        print('Ошибка при проверке объектов, не входящих в СПОДЕС!!!')
        raise e


def spodes(device_type, serial_number, proshivka):
    # reader, settings = connect_with_access_reader()
    try:
        reader, settings = connect_with_access_reader()
        print('____________________________________________________________________________________')
        print(f'Проверяется счетчик типа [{device_type}] [№{serial_number}] на прошивке [{proshivka}] (СПОДЕС)...')
        ...
        print(f'\nПРОВЕРКА счетчика [№{serial_number}] типа [{device_type}] (СПОДЕС) ЗАКОНЧЕНА')
        print('_____________________________________________________________________________')
    except Exception as e:

        print('Ошибка при проверке объектов СПОДЕС!!!')
        raise e
